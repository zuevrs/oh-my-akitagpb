...
const ASSET_ENTRIES = Object.freeze({
  'commands/akita-scan': 'commands/akita-scan.md',
  'commands/akita-plan': 'commands/akita-plan.md',
  'commands/akita-write': 'commands/akita-write.md',
  'commands/akita-accept': 'commands/akita-accept.md',
  ...
  'opencode/skills/akita-accept-workflow': 'opencode/skills/akita-accept-workflow/SKILL.md',
  ...
  'oma/templates/feature/README': 'oma/templates/feature/README.md',
  'oma/templates/feature/default': 'oma/templates/feature/default.feature.md',
  'oma/templates/feature/with-background': 'oma/templates/feature/with-background.feature.md',
  'oma/templates/feature/with-omissions-note': 'oma/templates/feature/with-omissions-note.feature.md',
  'oma/templates/payload/README': 'oma/templates/payload/README.md',
  'oma/templates/payload/json-body': 'oma/templates/payload/json-body.md',
  'oma/templates/payload/property-file': 'oma/templates/payload/property-file.md',
  'oma/templates/payload/minimal-fixture': 'oma/templates/payload/minimal-fixture.md',
  ...
  'oma/templates/accept/state-contract': 'oma/templates/accept/state-contract.json',
  'oma/templates/accept/accept-summary': 'oma/templates/accept/accept-summary.md',
...
export function readPackageSurface(packageRoot: string = resolvePackageRoot()): PackageSurface {
  ...
  const namespacedBinPath = typeof binRecord?.['oh-my-akitagpb'] === 'string' ? binRecord['oh-my-akitagpb'] : undefined;
  const binRelativePath = typeof binField === 'string' ? binField : namespacedBinPath;

  if (!binRelativePath) {
    throw new PackageSurfaceError(
      'package-bin-missing',
      'The package.json file must expose the oh-my-akitagpb bin entry.',
      { packageJsonPath },
    );
  }
