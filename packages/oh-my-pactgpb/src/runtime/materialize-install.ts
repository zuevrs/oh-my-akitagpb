...
import { PACK_RUNTIME_ROOT, PROJECT_MODE_RELATIVE_PATH, VERSION_RELATIVE_PATH } from './layout.js';
...
export function planMaterializedFiles(
  ...
  return [
    ...
    {
      relativePath: '.opencode/commands/pact-write.md',
      content: loadAssetText(catalog, 'commands/pact-write'),
      generatedBy: 'asset',
    ...
    {
      relativePath: '.opencode/skills/pact-write-workflow/SKILL.md',
